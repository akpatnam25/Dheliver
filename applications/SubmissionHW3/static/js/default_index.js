...
var app = function() {
    ...
    self.submit_add_track = function() {
        self.vue.is_adding_track_info = false;
        self.vue.is_adding_track = false;
        $("div#uploader_div").hide();
         $("div#textbox_div").hide();
    ...
    self.toggle_pub = function(track_idx){
        $("div#button-div").hide();
    ...
    self.edit_track = function(track_idx){
          self.add_track_button();
          self.delete_track(track_idx);
        var track = self.vue.tracks[track_idx]
        $.post(add_track_url,
            {
                artist: self.vue.form_artist,
    ...
    self.vue = new Vue({
        ...
        methods: {
            ...
            submit_add_track: self.submit_add_track,
